...
public class CustomInsetsFrameLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        final TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.CustomInsetsFrameLayout, defStyle, 0);
        if (a == null) {
            return;
        }
        mInsetForeground = a.getDrawable(R.styleable.CustomInsetsFrameLayout_insetForeground);
        mConsumeInsets = a.getBoolean(R.styleable.CustomInsetsFrameLayout_consumeInsets, true);
        a.recycle();
